...
| [#175](https://github.com/innovateavitech/trips-agent/issues/175) | Three loose ends — **quote tokens stored in plain text and the allowance release function trusting the caller are left**. The evidence assets are fixed above | Low |
