...
| `feat/M3-subagents` | 3 | F10: the sub-agent network, allowances and refusals (#63) | agent working |
...
**Two one-line calls still owed**, both waiting on a branch that now exists. The catalog's publish
